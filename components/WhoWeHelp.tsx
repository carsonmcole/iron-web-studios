          ...
          {businesses.map(({ icon: Icon, label }, i) => {
            ...
            return (
              <motion.div
                ...
                className={`gpu-stable group flex flex-col items-center gap-3 p-5 rounded-xl panel-chrome transition-[transform,translate,box-shadow,border-color,background-color] duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.4)] cursor-default ${c.hover}`}
              >
                <div
