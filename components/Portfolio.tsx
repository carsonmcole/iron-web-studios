        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {placeholders.map((item, i) => (
            <motion.div
              ...
              className="gpu-stable group relative rounded-2xl border border-hairline overflow-hidden bg-gradient-to-br from-white/[0.05] to-transparent aspect-video flex flex-col items-center justify-center gap-3 transition-[transform,translate,box-shadow,border-color,background-color] duration-300 hover:border-chrome/40 hover:-translate-y-1"
            >
              {/* Mock browser chrome */}
